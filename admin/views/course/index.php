      ...
      <div class="box">
        ...
        <div class="box-body  table-responsive">
          ...
          <table width="100%" class="table table-striped table-advance table-hover table-bordered">
              <tbody>
                <tr>
                  <th width="7%"><i class="fa fa-list-ol"></i></th>
                  <th width="28%"><strong>Title</strong></th>
                  <th width="16%"><strong>Status</strong></th>
                  <th width="12%"><i class="fa fa-cogs"></i> Action</th>
                </tr>
                <?php
                ...
                <tr>
                  ...
                  <td><a href="./?rt=course.edit_course&id=<?php echo clean($ras['id']);?>" class="btn btn-success"><i class="fa fa-pencil"></i></a> &nbsp;<a href="./?rt=course&todo=delete&id=<?php echo $ras['id'];?> "  onClick="return confirm('Do you want to delete this?')" class="btn btn-danger btn-sm" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o fa-lg"></i></a></td>
                </tr>
                <?php $count++; } ?>
              </tbody>
            </table>
