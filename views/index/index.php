...
<head>
    ...
    <link href="designs/css/bootstrap.css" rel="stylesheet" type="text/css" media="all">
    <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
    <script src="designs/js/jquery-1.11.0.min.js"></script>
    <!-- Custom Theme files -->
    <link href="designs/css/style.css" rel="stylesheet" type="text/css" media="all"/>
    <!-- Custom Theme files -->
    ...
    <script type="text/javascript" src="designs/js/move-top.js"></script>
    <script type="text/javascript" src="designs/js/easing.js"></script>
    ...
    <!-- //end-smoth-scrolling -->
    <link rel="stylesheet" href="designs/css/flexslider.css" type="text/css" media="screen" />
</head>
<body>
<!--banner start here-->
<div class="banner">
...
<!--banner end here-->
<!-- FlexSlider -->
<script defer src="designs/js/jquery.flexslider.js"></script>
<script type="text/javascript">
    $(function(){
